...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/wait-for-lb
#!/bin/bash
set -e
...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/use-cluster
#!/bin/bash
set -e
...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/awshttp
#!/bin/bash
set -e
...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/delete-all-if-crd-exists
#!/bin/bash
set -e
...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/delete-all-and-wait-if-crd-exists
#!/bin/bash
set -e
...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/delete-nodegroup
#!/bin/bash
set -e
...
EOT"
  ...
  sudo -E bash -c "cat << \EOT > /usr/local/bin/uninstall-helm-chart
#!/bin/bash
set -e
